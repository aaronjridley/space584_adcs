...
1. Testbed development (this would probably be limited to the first half of the semester) + Structure (ME heavy)
2. Algorithm development (CS heavy)
3. Sensors and Controllers (EE heavy)
4. Project manager who leads the team and is in charge of documentation (systems engineering heavy)
